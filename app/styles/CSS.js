...
const css = StyleSheet.create({
	...
	cb_textStyle: { color: COLOR.DGREY, marginLeft: 30, marginRight: 30, fontSize: 18, height: 105, paddingLeft: 10, paddingVertical: 10, textAlign: "center", justifyContent: 'center' },
